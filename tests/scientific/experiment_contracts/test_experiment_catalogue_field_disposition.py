...
_DISPOSITIONS: dict[str, Disposition] = {
    ...
    "population_readiness_rule.blocked_population_outcome": "SCIENTIFIC",
    "population_readiness_rule.blocks_only_experiments_binding_that_population": "SCIENTIFIC",
    "population_readiness_rule.blocked_population_reporting": "SCIENTIFIC",
    "analysis_conventions.paired_delta_definition": "SCIENTIFIC",
    "analysis_conventions.delta_direction_resolution": "SCIENTIFIC",
    "analysis_conventions.raw_metric_direction_resolution": "SCIENTIFIC",
    ...
    "experiments.analyses.expected_metric": "SCIENTIFIC",
    "experiments.analyses.expected_first_threshold_policy": "SCIENTIFIC",
    "experiments.analyses.expected_second_threshold_policy": "SCIENTIFIC",
    ...
    "experiments.primary_coefficient_selection.rule": "SCIENTIFIC",
    "experiments.primary_coefficient_selection.tie_break": "SCIENTIFIC",
    "experiments.primary_coefficient_selection.forbidden_selectors": "SCIENTIFIC",
    "experiments.primary_coefficient_selection.external_dataset_may_select_the_coefficient": "SCIENTIFIC",
    "experiments.primary_coefficient_selection.complete_grid_reported": "SCIENTIFIC",
    "experiments.primary_coefficient_selection.post_hoc_coefficient_addition": "SCIENTIFIC",
    "experiments.training_overrides": "SCIENTIFIC",
    "experiments.analyses.matching_contract.evaluation_label_mapping": "SCIENTIFIC",
    "experiments.analyses.matching_contract.permitted_to_differ": "SCIENTIFIC",
    "experiments.analyses.matching_contract.required_equal": "SCIENTIFIC",
    "experiments.analyses.alternative_path_rule.formula": "SCIENTIFIC",
    "experiments.analyses.alternative_path_rule.reported_independently_of_the_absorption_band": "SCIENTIFIC",
    "experiments.calibration_subset.full_calibration_reference_condition.label": "SCIENTIFIC",
    "experiments.calibration_subset.full_calibration_reference_condition.requested_sample_count": "SCIENTIFIC",
    "experiments.calibration_subset.full_calibration_reference_condition.eligibility_policy": "SCIENTIFIC",
    "experiments.calibration_subset.full_calibration_reference_condition.included_in_evaluations_analyses_and_reporting": "SCIENTIFIC",
}
