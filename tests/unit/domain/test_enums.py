    ...
    (
        ...
        frozenset(
            (
                ...
                "PHYSICAL_FAMILY_ADEQUACY",
                "CALIBRATION_SUPPORT_BURDEN",
                "NATURAL_DEVICE_CLIENT_IMPACT",
                "MALWARE_FAMILY_SENSITIVITY",
                "HETEROGENEITY_CALIBRATION_SUPPORT_INTERACTION",
    ...
    (
        ...
        frozenset(
            (
                ...
                "MEAN_ABSOLUTE_TEST_FPR_TARGET_ERROR",
