...
def test_fine_tuning_seed_is_stable_per_client_and_distinct_between_clients() -> None:
    ...
    assert derive_fedavg_local_fine_tuning_seed(Seed(7), first) == derive_fedavg_local_fine_tuning_seed(Seed(7), first)
    assert derive_fedavg_local_fine_tuning_seed(Seed(7), first) != derive_fedavg_local_fine_tuning_seed(Seed(7), second)
