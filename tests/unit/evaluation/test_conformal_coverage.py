...
from datp_core.domain.values import CoverageTarget, RowCount, ScoreValue, Seed, ThresholdValue
...
def test_conformal_coverage_empty_held_out_benign_scores_is_typed_unavailable() -> None:
    ...
    assignment = ConformalAssignment(client, RowCount(10), 10, 1.0, ScoreValue(0.5), 0, ThresholdValue(0.5))
