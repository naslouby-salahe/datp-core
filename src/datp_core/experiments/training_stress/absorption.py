...
class AbsorptionCornerEvidence(StrictModel):
    ...
    population: str #TODO:should be a class. Check what already exists. Do not use primitives for this, use something else. Check what already exists
...
class AbsorptionSeedObservation(StrictModel):
    ...
    ratio_unavailable_reason: str | None = None #TODO:should be a class. Check what already exists. Do not use primitives for this, use something else. Check what already exists
...
class AbsorptionCohortResult(StrictModel):
    ...
    alternative_route_seed_count: int = 0 #TODO:should be a class. Check what already exists. Do not use primitives for this, use something else. Check what already exists
...
def _classify_cohort(
    *,
    ...
    opposite_count: int, #TODO:should be a class. Check what already exists. Do not use primitives for this, use something else. Check what already exists
