...
_FEDERATED_STATISTICS_COMPARISON_METHODS = _SHARED_THRESHOLD_CONSTRUCTION_PANEL
_FEDERATED_QUANTILE_COMPARISON_METHODS = _SHARED_THRESHOLD_CONSTRUCTION_PANEL
...
_HETEROGENEITY_SUPPORT_INTERACTION_METHODS = _SHARED_LOCAL_AND_GROUPED_METHODS + (
    FederatedThresholdMethod.LOCAL_GLOBAL_SHRINKAGE,
    FederatedThresholdMethod.SIZE_AWARE_SHRINKAGE,
)
...
EXPERIMENTS = (
    ...
    _declare(
        ...
        TrainingModelId.FEDAVG_AUTOENCODER,
        PreprocessingProtocolId.FEDERATED_CLIENT_LOCAL_STANDARD,
        _HETEROGENEITY_SUPPORT_INTERACTION_METHODS,
        CONFIRMATORY_METRICS,
    ),
    _declare(
