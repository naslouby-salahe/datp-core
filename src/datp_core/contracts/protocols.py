...
These records are pure-data attrs classes owned by contracts/ (imports only core/ and third-party
schema libraries) so every feature package can import them without creating circular or
transitive import violations.
"""
