"""DuckDB in-memory read-only SQL query and result auditing service over committed Parquet
artifacts -- used exclusively by the CLI's ad-hoc query command."""
