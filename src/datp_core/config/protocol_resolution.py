...
Ownership boundary: converts authored protocol Pydantic models into immutable
domain records. Exports a narrow function surface; does not import composition,
CLI, or infrastructure.
"""
