"""Deterministic, read-only inspection of resolved dataset source contracts, and readiness/gate
evaluation that decides whether materialization output is usable for training."""
...
from datp_core.core.identifiers import DatasetId, DatasetSetupId, ExperimentId
from datp_core.data.contracts import ConfiguredSourceTree, DatasetSetup, ResolvedDataset
from datp_core.data.manifests import MaterializedSplitEvidence, SplitManifest, SplitMembership
