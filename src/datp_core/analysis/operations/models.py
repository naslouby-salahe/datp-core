...
Operational-contract configuration schema (field encodings, threshold/model exchange, checkpoint
storage, benign decision rate) moved to ``datp_core.config.operational_contracts`` -- it is
configuration, not analysis-execution results.
"""
