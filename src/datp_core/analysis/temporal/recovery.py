"""Temporal recovery: whether a one-shot recalibration recovers CV(FPR) drift accrued by a frozen
threshold, expressed as a specialized paired-seed comparison against the static baseline."""
...
def analyze_temporal_recovery(
    ...
    *,
    ...
    return TemporalRecoveryAnalysisResult(
        ...
        drift_confidence_interval=(record.confidence_interval.lower_bound,
