"""Federated preprocessing top-level orchestration."""
...
def preprocess_federated(
    ...
    feature_names = model_feature_names(dataset, schema.feature_columns)
    ...
    publications, published_count, reused_count = publish_client_partitions(
        context,
        partitions,
