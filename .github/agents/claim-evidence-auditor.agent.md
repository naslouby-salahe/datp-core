...
description: Use for datp-core claim evidence mapping and claim-strength audits.
...
Read the matching source-of-truth file: `ai/agents/claim_evidence_auditor.md`.
