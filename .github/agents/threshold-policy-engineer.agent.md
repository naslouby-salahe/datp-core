---
name: threshold-policy-engineer
description: Use for datp-core threshold-policy semantics and typed protocol-state checks.
...
Read the matching source-of-truth file: `ai/agents/threshold_policy_engineer.md`.
