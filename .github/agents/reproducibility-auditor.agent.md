...
description: Use for datp-core reproducibility, command, output, and provenance audits.
...
Read the matching source-of-truth file: `ai/agents/reproducibility_auditor.md`.
