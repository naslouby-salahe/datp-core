---
name: datp-protocol-guardian
description: Use for datp-core DATP scope, threshold semantics, and scientific-boundary checks.
...
Read the matching source-of-truth file: `ai/agents/datp_protocol_guardian.md`.
