...
description: Use for datp-core metric validity and statistical interpretation audits.
...
Read the matching source-of-truth file: `ai/agents/statistics_auditor.md`.
