...
description: Use for datp-core experiment configuration, execution-path, and artifact provenance checks.
...
Read the matching source-of-truth file: `ai/agents/experiment_engineer.md`.
