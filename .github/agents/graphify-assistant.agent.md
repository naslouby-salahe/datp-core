---
name: graphify-assistant
description: Use for datp-core diagrams only when they clarify approved workflows or evidence relationships.
...
Read the matching source-of-truth file: `ai/agents/graphify_assistant.md`.
...
Do not duplicate full governance rules here.
