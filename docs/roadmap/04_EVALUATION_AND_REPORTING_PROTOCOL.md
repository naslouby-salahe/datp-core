...
The historical anchor's training hyperparameters, convergence rule, and checkpoint-selection procedure are canonical in [`SCIENTIFIC_SOURCE_OF_TRUTH.md` §7](./SCIENTIFIC_SOURCE_OF_TRUTH.md#7-model-and-training-protocol). Its five paired seed deltas use the historical 95% percentile bootstrap with 10,000 resamples and seed 42 (`historical_five_seed_percentile_bootstrap`, [SCIENTIFIC_SOURCE_OF_TRUTH.md §12](./SCIENTIFIC_SOURCE_OF_TRUTH.md#12-statistical-analysis)).
