...
- [x] Every artifact type in item 1 has a semantic direct path and recorded provenance (items 2–7).
...
- [x] Completed-output rejection is tied to the exact validation rules in §13 item 15 (item 6).
