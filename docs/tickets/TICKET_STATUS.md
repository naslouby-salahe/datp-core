...
| P2-T022 | Implement B0 centralized calibration and held-out score generation | IN_REVIEW | P2-T021, P1-T045. | 2026-07-16T18:00:00Z | 2026-07-16T18:15:00Z | — | — | PASS | PASS | PENDING | NONE | CentralizedClientCalibrationScoreArtifact/CentralizedClientTestScoreArtifact added (structurally reject FedAvg identities); B0CalibrationScoreGenerationWorkflow/B0TestScoreGenerationWorkflow reuse P2-T011's score_client_batch; B0ScoreGenerationConfig YAML-backed; 9 new tests pass; awaiting Checkpoint 3 closure |
| P2-T023 | Implement B0 pooled threshold, evaluation, statistics, and reporting route | IN_PROGRESS | P2-T022, P1-T026, P1-T049. | 2026-07-16T18:20:00Z | — | — | — | PASS (threshold only) | PASS (threshold only) | PENDING | NONE | B0PooledThresholdSpec + compute_b0_pooled_threshold implemented and YAML-backed (8 tests pass); evaluation/statistics/reporting coverage NOT yet implemented - requires adapting the per-client evaluate_policy pipeline to B0's single pooled threshold, not completed this session; Checkpoint 3 cannot close until resolved |
