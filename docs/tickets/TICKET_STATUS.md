...
- **Current active ticket.** NONE — `P2-T013`, `P2-T014`, `P2-T015` are `DONE` (3 of 5 toward the next checkpoint: `P2-T013`, `P2-T014`, `P2-T015`, `P2-T016`, `P2-T017`).
- **Next eligible ticket.** `P2-T016` — `P2-T013`, `P2-T014`, `P2-T015` (`DONE`), `P2-T023` (`DONE`), and `P1-T026` are its dependencies.
- **Unresolved blockers.** `ANCHOR_LOCAL_EPOCH_PROTOCOL_UNRESOLVED` (print-grade; N.2b) remains open, carried to `P2-T020`. `ANCHOR_CHECKPOINT_PROTOCOL_UNRESOLVED` does not apply — resolved provisionally by N.2 and implemented by `P2-T010`.
...
- **Idempotent-rerun finding (2026-07-17).** Two undocumented working-tree commits ("Changes"/"CHanges", 2026-07-16T22:30Z–2026-07-17T21:07Z) had already implemented B0 centralized policy evaluation (`EvaluateCentralizedPolicyRequest`/`CentralizedPolicyEvaluationResult`) and a broader `RegimeDataSpec`/`DetectorBranchSpec` protocol refactor, without updating this register or `P2-T023.md`. The implementation was verified genuine (full suite, Ruff, Pyright, import-linter all green) and accepted as prior work rather than recreated; the register was corrected to match actual code state, not the other way around.
- **Configuration-catalogue migration.** Phase 2 and later tickets use the bounded named documents in `configs/scientific/`, `configs/execution/profiles.yaml`, `configs/artifacts/policy.yaml`, `configs/reporting/policy.yaml`, `configs/tests/profiles.yaml`, and `configs/locks/protocol-lock.json`. Retired `configs/protocols/`, per-experiment YAML, and override-composition paths are not valid implementation targets. `configs/scientific/thresholds.yaml` now also carries `b0_pooled_threshold` (locked p95), wired through `ThresholdCatalogConfig` → `map_profile_catalogue` → `ProfileCatalogueSpec.b0_pooled_threshold`; the protocol lock was refreshed for exactly that delta.
- **Last updated.** 2026-07-17T23:10:00Z (`P2-T013`/`P2-T014`/`P2-T015` completion — B1/B2/B3 verified and B4 config-catalogue defect fixed; no scientific execution performed).
- **Roadmap last-read timestamp.** 2026-07-17 (§4, §9 re-read for this ticket).
- **Architecture last-read timestamp.** 2026-07-17 (§9.2–§9.4, §22 re-read for this ticket).
...
| P2-T010 | Implement the checkpoint schedule, persistence, and Regime-A global selection | DONE | P2-T009, P2-T002, P1-T022. | 2026-07-16T15:35:00Z | 2026-07-16T16:10:00Z | 2026-07-16T16:35:00Z | Complete | PASS | PASS | PASS (local `cs delta`) | NONE | Checkpoint-2 (P2-T006..T010) closed: full local gates + Sonar API PASS for pushed 17541ec; CodeScene dashboard API is rate-limited (24/day, external, not a code finding) — by explicit user instruction local `cs delta --error-on-warnings` (exit 0, 0 findings) substitutes for the dashboard check going forward |
| P2-T011 | Implement calibration, benign-test, and malicious-test scoring with atomic score bundles | DONE | P2-T010, P1-T045. | 2026-07-16T16:40:00Z | 2026-07-17T22:35:00Z | 2026-07-17T22:35:00Z | Complete | PASS | PASS | PASS | NONE | AnchorCalibration/TestScoreGenerationWorkflow implemented (infrastructure/scoring/anchor.py), reusing the existing FileArtifactBundleStore atomic commit unchanged; shared scoring batching is now owned by `configs/execution/profiles.yaml`; 8 new tests pass; Checkpoint 3 closed (1 of 5) |
| P2-T012 | Implement B0 centralized training branch | DONE | P2-T006, P1-T044. | 2026-07-16T17:15:00Z | 2026-07-17T22:35:00Z | 2026-07-17T22:35:00Z | Complete | PASS | PASS | PASS | NONE | CentralizedPooledBenignTrainingExecutor implemented, structurally rejects FedAvg identities; comparator configuration is subject to the bounded scientific catalogue migration; 6 new tests pass; Checkpoint 3 closed (2 of 5) |
| P2-T013 | Implement canonical anchor B1 shared construction | DONE | P2-T011, P1-T024. | 2026-07-17T23:00:00Z | 2026-07-17T23:10:00Z | 2026-07-17T23:10:00Z | Complete | PASS | PASS | PASS | NONE | SharedThresholdStrategy found already implemented (undocumented prior commit, verified genuine); closed the one real gap with a new eligible-only-mean integration test; 1 of 5 for the next checkpoint |
| P2-T014 | Implement B2 per-client and B3 family constructions | DONE | P2-T013. | 2026-07-17T23:00:00Z | 2026-07-17T23:10:00Z | 2026-07-17T23:10:00Z | Complete | PASS | PASS | PASS | NONE | LocalThresholdStrategy/FamilyThresholdStrategy found already implemented (undocumented prior commit, verified genuine); closed the B3-no-eligible-members gap with a new integration test; 2 of 5 for the next checkpoint |
| P2-T015 | Implement canonical anchor B4 exact k-means++ clustering and cluster-mean thresholds (K=3) | DONE | P2-T014, P1-T025. | 2026-07-17T23:00:00Z | 2026-07-17T23:10:00Z | 2026-07-17T23:10:00Z | Complete | PASS | PASS | PASS | NONE | Fixed a real defect: B4ClusteringSpec sourced n_init/max_iter/scikit-learn-version from bare Python constants instead of configs/scientific/thresholds.yaml; added CanonicalB4ClusteringProfile + typed mapper + config wiring; 3 of 5 for the next checkpoint |
...
| P2-T021 | Implement B0 centralized checkpoint schedule and scientific checkpoint selection | DONE | P2-T012, P2-T002, P1-T022. | 2026-07-16T17:45:00Z | 2026-07-17T22:35:00Z | 2026-07-17T22:35:00Z | Complete | PASS | PASS | PASS | NONE | B0CentralizedCheckpointStager + validating select_centralized_checkpoint() implemented reusing P1-T044's CentralizedTrainingRunResult; no B0-specific schedule evidence exists so NONE config state preserved per ticket's own template; 5 new tests pass; Checkpoint 3 closed (3 of 5) |
| P2-T022 | Implement B0 centralized calibration and held-out score generation | DONE | P2-T021, P1-T045. | 2026-07-16T18:00:00Z | 2026-07-17T22:35:00Z | 2026-07-17T22:35:00Z | Complete | PASS | PASS | PASS | NONE | CentralizedClientCalibrationScoreArtifact/CentralizedClientTestScoreArtifact added (structurally reject FedAvg identities); B0 score batching derives from the shared execution profile rather than a second YAML document; 9 new tests pass; Checkpoint 3 closed (4 of 5) |
| P2-T023 | Implement B0 pooled threshold, evaluation, statistics, and reporting route | DONE | P2-T022, P1-T026, P1-T049. | 2026-07-16T18:20:00Z | 2026-07-17T22:35:00Z | 2026-07-17T22:35:00Z | Complete | PASS | PASS | PASS | NONE | B0 evaluation route (found already implemented in undocumented commits, verified genuine) plus this ticket's own work: `b0_pooled_threshold` wired end-to-end through `ThresholdCatalogConfig`/`configs/scientific/thresholds.yaml`/`map_profile_catalogue`/`ProfileCatalogueSpec`, protocol lock refreshed; new `tests/integration/learning/test_b0_centralized_reporting.py` proves B0 routes through the generic `TableType.COMPARATOR` reporting path with a lineage-bearing `ReportIdentity`; B0 statistics coverage is the shared `CvOutcome` dispersion path (paired/bootstrap statistics remain P2-T018 scope, structurally downstream of this ticket). Full suite 670/670 both orders; Checkpoint 3 closed (5 of 5) |
