...
- **Current active ticket.** NONE — `P2-T010` is complete; Checkpoint 2 (`P2-T006`–`P2-T010`) is closed.
- **Next eligible ticket.** `P2-T011` — `P2-T010` is `DONE`; `P2-T011` begins Checkpoint 3 (`P2-T011`, `P2-T012`, `P2-T021`, `P2-T022`, `P2-T023`).
