...
- **Current active ticket.** `P2-T011` — implementation complete, `IN_REVIEW`, awaiting Checkpoint 3 closure (1 of 5: `P2-T011`, `P2-T012`, `P2-T021`, `P2-T022`, `P2-T023`).
- **Next eligible ticket.** `P2-T012` — `P2-T011` implementation-complete; `P2-T012` may proceed once its own dependencies are verified `DONE`.
...
| P2-T011 | Implement calibration, benign-test, and malicious-test scoring with atomic score bundles | IN_REVIEW | P2-T010, P1-T045. | 2026-07-16T16:40:00Z | 2026-07-16T17:10:00Z | — | — | PASS | PASS | PENDING | NONE | AnchorCalibration/TestScoreGenerationWorkflow implemented (infrastructure/scoring/anchor.py), reusing the existing FileArtifactBundleStore atomic commit unchanged; shared scoring batching is now owned by `configs/execution/profiles.yaml`; 8 new tests pass; awaiting Checkpoint 3 closure |
| P2-T012 | Implement B0 centralized training branch | IN_REVIEW | P2-T006, P1-T044. | 2026-07-16T17:15:00Z | 2026-07-16T17:35:00Z | — | — | PASS | PASS | PENDING | NONE | CentralizedPooledBenignTrainingExecutor implemented, structurally rejects FedAvg identities; comparator configuration is subject to the bounded scientific catalogue migration; 6 new tests pass; awaiting Checkpoint 3 closure |
...
| P2-T022 | Implement B0 centralized calibration and held-out score generation | IN_REVIEW | P2-T021, P1-T045. | 2026-07-16T18:00:00Z | 2026-07-16T18:15:00Z | — | — | PASS | PASS | PENDING | NONE | CentralizedClientCalibrationScoreArtifact/CentralizedClientTestScoreArtifact added (structurally reject FedAvg identities); B0 score batching derives from the shared execution profile rather than a second YAML document; 9 new tests pass; awaiting Checkpoint 3 closure |
| P2-T023 | Implement B0 pooled threshold, evaluation, statistics, and reporting route | IN_PROGRESS | P2-T022, P1-T026, P1-T049. | 2026-07-16T18:20:00Z | — | — | — | PASS (threshold only) | PASS (threshold only) | PENDING | NONE | B0PooledThresholdSpec + compute_b0_pooled_threshold implemented; its configuration belongs in the bounded scientific catalogue. Evaluation/statistics/reporting coverage remains incomplete; Checkpoint 3 cannot close until resolved. |
