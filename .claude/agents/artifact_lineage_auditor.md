...
description: Use for datp-core artifact identity, lineage, and reuse-decision audits.
---

Read `AGENTS.md` first.
Read `ai/README.md`.
Use `ai/` as the source of truth.
Read the matching source-of-truth file: `ai/agents/artifact_lineage_auditor.md`.
