...
description: Use for datp-core implementation tasks requiring clean, typed, direct changes.
---

Read `AGENTS.md` first.
Read `ai/README.md`.
Use `ai/` as the source of truth.
Read the matching source-of-truth file: `ai/agents/implementation_engineer.md`.
