---
name: compatibility-blocker
description: Use for datp-core clean-break compatibility enforcement.
---

Read `AGENTS.md` first.
Read `ai/README.md`.
Use `ai/` as the source of truth.
Read the matching source-of-truth file: `ai/agents/compatibility_blocker.md`.
