---
name: report-output-auditor
description: Use for datp-core table/figure/report-output and provenance-closure audits.
---

Read `AGENTS.md` first.
Read `ai/README.md`.
Use `ai/` as the source of truth.
Read the matching source-of-truth file: `ai/agents/report_output_auditor.md`.
