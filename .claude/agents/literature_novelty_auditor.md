---
name: literature-novelty-auditor
description: Use for datp-core novelty, related-work, and literature-overlap audits.
---

Read `AGENTS.md` first.
Read `ai/README.md`.
Use `ai/` as the source of truth.
Read the matching source-of-truth file: `ai/agents/literature_novelty_auditor.md`.
