---
name: reviewer2-red-team
description: Use for datp-core reviewer-risk and overclaiming audits.
---

Read `AGENTS.md` first.
Read `ai/README.md`.
Use `ai/` as the source of truth.
Read the matching source-of-truth file: `ai/agents/reviewer2_red_team.md`.
